        ...
        <>
            ...
            <ul id="menu-primary-menu" className="menu">
                <li className="menu-item menu-item-has-children">
                    ...
                    {/* <Link href="/about-us"><span className="menu_item">About us</span></Link> */}
                    {/* <li className={router.pathname == "/home" ? "menu-item current-item" : "menu-item"}></li> */}
                    <Link href="/home"><span className="menu_item">Home</span></Link>
                    {/* <ul className="sub-menu">
                        <li className={router.pathname == "/home" ? "menu-item current-item" : "menu-item"}><Link href="/home">Home</Link></li>
                ...
                <li className="menu-item menu-item-has-children">
                    <Link href="/about-us"> <span className="menu_item">Explore</span></Link>
                    {/* <ul className="sub-menu">
                ...
                <li className="menu-item menu-item-has-children">
                    <Link href="/contact-us"> <span className="menu_item">Pages</span></Link>
                    {/* <ul className="sub-menu">
                        <li className="menu-item has-item">
                ...
                <li className="menu-item menu-item-has-children">
                    <Link href="/contact-us"><span className="menu_item">Blog</span></Link>
                    {/* <ul className="sub-menu">
                ...
                <li className={router.pathname == "/contact-us" ? "menu-item current-item" : "menu-item"}>
                    <Link href="/contact-us"><span className="menu_item">Contact</span></Link>
                </li>
            </ul>
        </>
    )
